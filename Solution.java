...
class Board{
	...
	/*Metoda Board care primeste ca parametri doua int-uri: lines, columns*/	
	...
	/*Metoda set care primeste doua int-uri(line, column) si un string s si seteaza linia si coloana din board la s"*/	
